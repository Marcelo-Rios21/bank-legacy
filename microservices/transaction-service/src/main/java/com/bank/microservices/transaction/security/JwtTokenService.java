...
public class JwtTokenService {
    ...
    public TransactionTokenResponse createToken(Authentication authentication) {
        ...
        JwtClaimsSet claims = JwtClaimsSet.builder()
                .issuer("bank-transaction-service")
                .issuedAt(now)
                .expiresAt(now.plusSeconds(EXPIRES_IN_SECONDS))
                .subject(authentication.getName())
                .claim("roles", roles)
                .claim("service", "transaction")
                .build();
        ...
        return new TransactionTokenResponse(
                token,
                "Bearer",
                EXPIRES_IN_SECONDS);
    }
